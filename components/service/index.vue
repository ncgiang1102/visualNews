<template>
    <div class=" container  " style="margin: 0px 139.60px;padding: 0px;max-width: 1240px;">
        <div style=" flex-direction: row;gap:40px" class="row head-tab g-3">
            <div class="col tab">
...
.col.tab {
    max-width: 392px;
    flex: 1;
    /* Để các cột con trong flex container chiếm đều chiều rộng và không bị đè lên nhau */
    padding: 0 10px;
    /* Khoảng cách giữa các cột */
    box-sizing: border-box;
    /* Đảm bảo padding không làm tăng kích thước thực tế của cột */
}
